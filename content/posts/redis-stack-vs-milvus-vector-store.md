---
title: "Redis Stack 向量库改造实录：Redis vs Milvus 六大对比"
date: "2025-07-12"
draft: false
categories: ["Agent"]
tags: ["向量数据库", "Redis", "Milvus", "RAG", "Eino"]
summary: "Redis 是 KV 外挂 RediSearch 模块，Milvus 本体就是向量库。六大维度对比：向量能力本质、建索引与写数据顺序、schema 管理、协议、结果解析、持久化。"
---
