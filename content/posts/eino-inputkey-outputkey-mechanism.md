---
title: "Eino InputKey/OutputKey 机制深度分析"
date: "2025-07-05"
draft: false
categories: ["Agent"]
tags: ["Eino", "Graph", "Channel", "Go", "源码阅读"]
summary: "InputKey/OutputKey 不是类型约束，是数据格式转换指令。Channel 内部 key（前驱节点名）与用户 Key 是两套独立体系；START 节点特殊，Key 模式下第一个节点不能设 InputKey。"
---
